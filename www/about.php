...
<div id="container" class="page-about">
  ...
  <div class="center">
    ...
    <p class="head next">Для чего этот сайт?</p>
    ...
    <p class="head next">Как связаться с сообществом OpenStreetMap?</p>
