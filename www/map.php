...
<div id="toppan">
  ...
  <div id="searchcont"><div id="searchpan"><table style="width:100%;"><tr><td><input id="search" autocomplete="off" type="search" /></td><td style="width:1px;"><button onClick="search.search();">Найти&nbsp;&raquo;</button></td></tr></table></div></div>
  <? show_menu(); ?>
